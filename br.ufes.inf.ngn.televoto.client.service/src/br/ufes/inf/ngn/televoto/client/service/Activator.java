package br.ufes.inf.ngn.televoto.client.service;
		...
		if(jadeRef != null) {
			...
			try {
				...
				for ( ; i<lastExtension; i++, k++) {
					...
					ac = jrs.createNewAgent(parametros[0].toString(), "br.ufes.inf.ngn.televoto.client.logic.Listener", parametros, "br.ufes.inf.ngn.televoto.client.logic");
					ac.start();
