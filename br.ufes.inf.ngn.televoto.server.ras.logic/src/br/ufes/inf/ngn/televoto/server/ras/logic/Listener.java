...
public class Listener extends Agent implements SipListener {
	...
	/* M�todo externo para configurar e iniciar o agente.
	 * */
	...
	public void setup () {
		try {
			...
			port   	   	= (Integer) parametros[3]; // Porta SIP de escuta do servi�o televoto
	...
	/* M�todo externo para finalizar o agente e salva os dados no arquivo.
	 * */
	...
	/* M�todo externo para processar requisi��es SIP.
	 * @param requestReceivedEvent - evento de requisi��o SIP.
	 * */
	...
	/* M�todo externo para processar respostas SIP.
	...
	/* M�todo externo para receber conex�es via socket.
	 * */
	...
	/* M�todo interno para receber conex�es via socket.
	 * */
	...
	/* M�todo interno para verificar a quantidade de agentes dispon�veis em rela��o a quantidade de chamadas. 
	 * A op��o "timeoutWaitingService" deve estar habilitada no arquivo de configura��o.
	 * */
	...
	/* M�todo interno para iniciar mais agentes. E depois para inserir esses agentes no sistema.
	 * @param quantity - quantidade de agentes que ser�o iniciados. Setar valor para ZERO, para que seja definida a quantidade automaticamente.  
	 * */
	...
	/* M�todo interno para reiniciar agentes. E depois para ataualizar esses agentes no sistema.
	 * @param qtt - quantidade de agentes que ser�o parados.  
	 * */
	...
	/* M�todo interno para encerrar agentes. E depois para inserir esses agentes no sistema.
	 * @param qtt - quantidade de agentes que ser�o parados.  
	 * */
	...
	/* M�todo interno para consultar os agentes dispon�veis, e inser�-los no sistema.
	 * */
	...
	/* Classe para verificar se h� um AS dispon�vel.
	 * Se tiver um agente dispon�vel, ser� enviada a requisi��o para ele.
	 * */
	...
	/* M�todo interno para inserir um agente dispon�vel (que antes estava ocupado), no final da fila de agentes ociosos.
	...
	/* M�todo interno para manter o registro do agente.
	 * */
	...
	/* M�todo interno para registrar/desregistrar um agente.
	 * @param step -  fase do processo de autentica��o. Valores 1 ou 2.
	 * */
	...
	public class RAS implements SipListener {
		...
		/* M�todo construtor da classe, que seta os par�metros iniciais.
		 * @param myCallID - Identifica��o da chamada. */
		@SuppressWarnings("deprecation")
		...
		/* M�todo interno que retorna o status do servi�o/atendimento.
		...
		/* M�todo interno que retorna a identifica��o da chamada.
		 * @return String - identifica��o da liga��o.
		 * */
		public String getCallID() {
			return callID;
		}

		/* M�todo interno que retorna o nome do AS.
		 * @return String - nome do AS, sem o dom�nio.
		 * */
		public String getAS() {
			return asAddress.split("@")[0];
		}
		
		/* M�todo interno que retorna o nome do cliente.
		 * @return String - nome do cliente, sem o dom�nio.
		 * */
		public String getUE() {
			return ueAddress.split("@")[0];
		}		
		
		/* M�todo interno que retorna o tempo de espera do cliente, at� que inicie a negocia��o com um AS dispon�vel.
		 * @return long - tempo de espera para in�cio da negocia��o.
		 * */
		...
		/* M�todo interno que retorna o tempo de espera do cliente, at� que a liga��o tenha sido estabelecida com o AS e o cliente.
		 * @return long - tempo de espera at� que a liga��o seja estabelecida.
		 * */		
		...
		/* M�todo interno que retorna o tempo total da liga��o, at� que receba o BYE.
		 * @return long - tempo total da liga��o.
		 * */	
		public long getTimeTotal() {
			return (timeCallEnd.getTimeInMillis() - timeCallArrival.getTimeInMillis());
		}
		
		/* Classe para verificar se a resposta a uma solicita��o, foi respodinda em um tempo definido.
		 * Se o tipo de requisi��o for "INVITE" e n�o for respondido dentro do tempo difinido, ent�o ser� selecionado outro AS.
		 * Se o tipo de requisi��o for "BYE" e n�o for respondido dentro do tempo, o AS ser� inserido na fila de agentes ociosos e o RAS ser� removido.
		 * @param type = tipo de requisi��o, "INVITE" ou "BYE". 
		 * @param ras = objeto RAS que ser� removido (this).
		 * */
		...
		/* Classe para verificar se o tempo de estabelecimento da chamada est� maior que o normal.
		 * Se o tempo tiver excedido, a liga��o ser� encerrada e o RAS exclu�do.
		 * Para funcionar � necess�rio setar a op��o no arquivo de configura��o.
		 * */
		...
		/* Classe para verificar se o tempo de negocia��o da chamada est� maior que o normal.
		 * Se o tempo tiver excedido, a liga��o ser� encerrada e o RAS exclu�do.
		 * Para funcionar � necess�rio setar a op��o no arquivo de configura��o.
		 * */
		...
		/* M�todo interno para enviar um requisi��o INVITE para um AS.
		 * */
		...
		/* M�todo interno para enviar uma resposta do tipo "180" para o cliente.
		 * */
		...
		/* M�todo interno para processar requisi��es SIP.
		 * @param requestReceivedEvent - evento de requisi��o SIP.
		 * */
		public synchronized void processRequest(RequestEvent requestReceivedEvent) {
		...
		/* M�todo interno para processar respostas SIP.
		 * @param responseReceivedEvent - evento de resposta SIP.
		 * */
		public synchronized void processResponse(ResponseEvent responseReceivedEvent) {
			try{
