...
public class Activator implements BundleActivator {
	...
	/* M�todo externo para iniciar agentes. Geralmente chamado por outra classe.
	 * @param quantity - quantidade de agentes que ser�o encerrados.
	 * */
	...
	/* M�todo externo para iniciar agentes. Geralmente chamado pela linha de comando OSGi.
	...
	/* M�todo externo para encerrar agentes. Geralmente chamado por outra classe.
	 * @param list - nome dos agentes que ser�o parados
	 * */
	...
	/* M�todo externo para encerrar agentes. Geralmente chamado pela linha de comando OSGi.
	 * @param context - contexto do bundle.
	 * */
	...
	/* M�todo externo para reiniciar um agente "travado". Geralmente chamado por outra classe.
	...
	/* M�todo externo que retorna os agentes registrados. Geralmente chamado pela linha de comando OSGi.
	...
	/* M�todo interno para iniciar agentes.
	 * @param quantity - quantidade de agentes que ser�o encerrados.
	 * */
	@SuppressWarnings("unchecked")
	...
	/* M�todo interno para iniciar agente que estava "travado".
	 * @param id - nome do agente que ser� inicializado.
	 * */
	@SuppressWarnings("unchecked")
	...
	/* M�todo interno para encerrar agentes.
	 * @param quantity - quantidade de agentes que ser�o encerrados.
	 * @param context - contexto do bundle
	 * */
	@SuppressWarnings("unchecked")
	...
	/* M�todo interno para ler o arquivo de configura��o.
	 * */
