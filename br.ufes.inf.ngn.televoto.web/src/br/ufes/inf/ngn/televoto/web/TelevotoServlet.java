...
public class TelevotoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().write("<p class=\"title\">Histórico de Chamadas</p>");
		...
		resp.getWriter().write("<p>Totais: </p>");
		resp.getWriter().write("<p>Não atendidas: </p>");
		resp.getWriter().write("<p>Em negociação: </p>");
    	...
    	resp.getWriter().write("<p>Disponíveis: </p>");
